...
constexpr char CN_AT_INCLUDE[] = "@include";
...
constexpr char CN_INCLUDE[] = "include";
constexpr char CN_INET[] = "inet";
constexpr char CN_KIND[] = "kind";
...
constexpr char CN_PERSISTMAXTIME[] = "persistmaxtime";
constexpr char CN_PERSISTPOOLMAX[] = "persistpoolmax";
constexpr char CN_PORT[] = "port";
constexpr char CN_PROTOCOL[] = "protocol";
constexpr char CN_PROXY_PROTOCOL[] = "proxy_protocol";
...
constexpr char CN_REQUIRE_SECURE_TRANSPORT[] = "require_secure_transport";
constexpr char CN_RETAIN_LAST_STATEMENTS[] = "retain_last_statements";
constexpr char CN_ROUTER[] = "router";
constexpr char CN_RUNNING[] = "running";
