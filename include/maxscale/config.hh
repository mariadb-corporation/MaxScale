...
public:
    ...
    public:
        ...
        bool from_string(const std::string& value_as_string, value_type* pValue, std::string* pMessage) const;
    };
    ...
    public:
        ...
        ParamLogThrottling(config::Specification* pSpecification, const char* zName, const char* zDescription)
            : config::ConcreteParam<ParamLogThrottling, MXS_LOG_THROTTLING>(pSpecification,
                zName,
                zDescription,
                Modifiable::AT_RUNTIME,
                Param::OPTIONAL,
                MXS_MODULE_PARAM_STRING,
                MXS_LOG_THROTTLING {0, 0, 0})
        {}
    ...
    public:
        ...
        bool set_from_string(
            const std::string& value_as_string, std::string* pMessage = nullptr) override final
        {
    ...
    bool configure(
        const mxs::ConfigParameters& params, mxs::ConfigParameters* pUnrecognized = nullptr) override;
