...
ExternalProject_Add(mongo-c-driver
  ...
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${MONGO_C_DRIVER_INSTALL}  -DCMAKE_C_FLAGS=-fPIC -DENABLE_AUTOMATIC_INIT_AND_CLEANUP=OFF -DENABLE_TESTS=N -DENABLE_EXAMPLES=N -DENABLE_ZSTD=OFF
...
#set(BSON_C_LIBRARIES    ${MONGO_C_DRIVER_INSTALL}/lib/libbson-static-1.0.a CACHE INTERNAL "")
set(BSON_C_LIBRARIES    ${MONGO_C_DRIVER_BINARY}/src/libbson/libbson-static-1.0.a CACHE INTERNAL "")
...
#Depending on OS it's either lib or lib64, so for the time being taken from the build directory.
#set(MONGO_C_LIBRARIES   ${MONGO_C_DRIVER_INSTALL}/lib64/libmongoc-static-1.0.a CACHE INTERNAL "")
set(MONGO_C_LIBRARIES   ${MONGO_C_DRIVER_BINARY}/src/libmongoc/libmongoc-static-1.0.a CACHE INTERNAL "")
