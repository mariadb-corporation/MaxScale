...
ExternalProject_Add(mongo-cxx-driver
  ...
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${MONGO_CXX_DRIVER_INSTALL} -DCMAKE_PREFIX_PATH=${MONGO_C_DRIVER_INSTALL} -DCMAKE_C_FLAGS=-fPIC  -DCMAKE_CXX_FLAGS=-fPIC -DBUILD_SHARED_LIBS=OFF -DBUILD_STATIC_LIBS=ON -DBUILD_SHARED_AND_STATIC_LIBS=OFF -DBSONCXX_POLY_USE_STD=Y -DCMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD}
  ...
  BUILD_BYPRODUCTS ${MONGO_CXX_DRIVER_BINARY}/src/bsoncxx/libbsoncxx-static.a ${MONGO_CXX_DRIVER_BINARY}/src/mongocxx/libmongocxx-static.a
  LOG_DOWNLOAD 1
  LOG_UPDATE 1
  LOG_CONFIGURE 1
  LOG_BUILD 1
...
set(BSON_CXX_INCLUDE_DIR  ${MONGO_CXX_DRIVER_INSTALL}/include/bsoncxx/v_noabi CACHE INTERNAL "")
#Depending on OS it's either lib or lib64, so for the time being taken from the build directory.
#set(BSON_CXX_LIBRARIES    ${MONGO_CXX_DRIVER_INSTALL}/lib/libbsoncxx-static.a CACHE INTERNAL "")
set(BSON_CXX_LIBRARIES    ${MONGO_CXX_DRIVER_BINARY}/src/bsoncxx/libbsoncxx-static.a CACHE INTERNAL "")

set(MONGO_CXX_INCLUDE_DIR ${MONGO_CXX_DRIVER_INSTALL}/include/mongocxx/v_noabi CACHE INTERNAL "")
#Depending on OS it's either lib or lib64, so for the time being taken from the build directory.
#set(MONGO_CXX_LIBRARIES   ${MONGO_CXX_DRIVER_INSTALL}/lib/libmongocxx-static.a CACHE INTERNAL "")
set(MONGO_CXX_LIBRARIES   ${MONGO_CXX_DRIVER_BINARY}/src/mongocxx/libmongocxx-static.a CACHE INTERNAL "")
