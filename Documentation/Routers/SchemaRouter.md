...
ignored. Starting with MaxScale 7, the database names will always be in lowercase.
...
from the router itself. Starting with MaxScale 7, the database names will always be in lowercase.
