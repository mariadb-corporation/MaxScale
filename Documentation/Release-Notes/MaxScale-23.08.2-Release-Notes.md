...
* [MXS-4562](https://jira.mariadb.org/browse/MXS-4562) When MaxScale is installed from tarball and starded without -d option --basedir=.  is not parsed properly and full directory needs to be specified
