...
In MaxScale 22.08.11 and earlier, this setting defined the *only* allowed TLS
version, e.g. `ssl_version=TLSv12` would only enable TLSv12. The interpretation
changed in MaxScale 22.08.12 to allow the user to disable old versions while
