...
Starting with MaxScale 7, the maintenance state of servers will be synchronized
as well. In older versions servers had to be put into maintenance mode
separately on each MaxScale.
