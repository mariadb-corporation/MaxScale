...
Persist changes done at runtime. This parameter was added in MaxScale 22.8.0.
...
Asymmetric key algorithms make it possible for the clients of the REST
API to validate that the token was indeed generated by the correct
entity.
...
Starting with MaxScale 22.8, the `Maintenance` state of servers and modifications
