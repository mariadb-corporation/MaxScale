<template>
    ...
    <v-combobox
        ...
        outlined
        dense
        class="std mariadb-select-input max-rows-dropdown max-rows-dropdown--fieldset-border"
        :menu-props="{
            contentClass: 'mariadb-select-v-menu',
            bottom: true,
            offsetY: true,
        }"
        :rules="[v => handleValidateMaxRows(v)]"
        v-bind="{ ...$attrs }"
...
export default {
    ...
    methods: {
        ...
        onInput(evt) {
            this.maxRows = Number(evt.srcElement.value)
        },
    },
}
</script>
