...
describe(`QueryCnfDlgCtr - child component's data communication tests `, () => {
...
describe(`QueryCnfDlgCtr - tests after dialog is opened `, () => {
    let wrapper
    beforeEach(() => {
...
describe(`QueryCnfDlgCtr - form input tests`, () => {
    let wrapper
    beforeEach(() => {
        wrapper = mountFactory({ shallow: false })
    })
    const intFields = ['maxStatements', 'queryHistoryRetentionPeriod']
