...
import IndexList from '@wsSrc/components/common/MxsDdlEditor/IndexList'
import { editorDataStub } from '@wsSrc/components/common/MxsDdlEditor/__tests__/stubData'
...
describe('index-list', () => {
    ...
    describe(`Child component's data communication tests`, () => {
        ...
        it(`Should pass accurate data to mxs-virtual-scroll-tbl`, () => {
            ...
            expect(rows).to.be.eql(wrapper.vm.$data.keyItems)
