...
int main(int argc, char* argv[])
{
    ...
    int result = get_server_id(test.maxscale->conn_rwsplit[0]);
    ...
    test.try_query(test.maxscale->conn_rwsplit[0], "CALL multi()");
    result = get_server_id(test.maxscale->conn_rwsplit[0]);
