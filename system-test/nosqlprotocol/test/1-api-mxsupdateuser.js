...
describe(name, function () {
    ...
    before(async function () {
        ...
        await nosql.runCommand({mxsAddUser: "bob",
                                pwd: "bobspwd",
    ...
    it('Can update custom data.', async function () {
        ...
        await nosql.runCommand({mxsUpdateUser: "bob", customData: customData });
    ...
    it('Can update roles.', async function () {
        ...
        await nosql.runCommand({mxsUpdateUser: "bob", roles: roles});
    ...
    it('Can reduce mechanisms without providing password.', async function () {
        ...
        await nosql.runCommand({mxsUpdateUser: "bob", mechanisms: mechanisms});
    ...
    it('Cannot expand mechanisms without providing password.', async function () {
        ...
        try {
            await nosql.runCommand({mxsUpdateUser: "bob".user, mechanisms: mechanisms});
    ...
    it('Can expand mechanisms when providing password.', async function () {
        ...
        await nosql.runCommand({mxsUpdateUser: "bob", pwd: "bobs2ndpwd", mechanisms: mechanisms});
