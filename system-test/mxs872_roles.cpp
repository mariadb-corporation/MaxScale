...
int main(int argc, char** argv)
{
    ...
    MYSQL* conn =
        open_conn_db(test.maxscales->rwsplit_port[0], test.maxscales->ip4(0), "my_db", "test", "test");
    ...
    conn = open_conn_db(test.maxscales->rwsplit_port[0], test.maxscales->ip4(0), "my_db", "test2", "test2");
