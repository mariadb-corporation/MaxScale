...
static struct result
{
...
} queries[] =
    {
        ...
        {"select @@server_id;", SERVER1},
        {"select @@server_id; -- maxscale end", SERVER4},
        {"select @@server_id; -- maxscale named1 prepare route to master", SERVER4},
        ...
        {"select @@server_id;", SERVER1},
        {"select @@server_id; # maxscale end", SERVER4},
        {"select @@server_id; # maxscale named2 prepare route to master", SERVER4},
        ...
        {"select @@server_id;", SERVER1},
        {"select @@server_id/* maxscale end */;", SERVER4},
        {"select @@server_id/* maxscale named3 prepare route to master */;", SERVER4},
