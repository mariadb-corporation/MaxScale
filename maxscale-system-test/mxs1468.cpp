...
int main(int argc, char** argv)
{
    ...
    std::vector<std::string> commands =
    {
        ...
        "create server prod_mysql01 " + std::string(test.repl->IP[0]) + " 3306",
        "create server prod_mysql02 " + std::string(test.repl->IP[1]) + " 3306",
        "create server prod_mysql03 " + std::string(test.repl->IP[2]) + " 3306",
        "list servers",
