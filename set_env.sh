...
export repl_private_000="192.168.122.$r1"
export repl_private_001="192.168.122.$r2"
export repl_private_002="192.168.122.$r3"
export repl_private_003="192.168.122.$r4"
...
#	export start_db_command="/etc/init.d/mysqld start --report-user=$repl_user --report-password=$repl_password --report-host=$repl_000"
	export start_db_command="echo \"nohup mysqld_safe --report-user=skysql --report-password=skysql --report-host=$repl_000 > /dev/null 2> /dev/null & \" > mysql_start; echo \"sleep 10\" >> mysql_start; chmod a+x mysql_start; ./mysql_start"
