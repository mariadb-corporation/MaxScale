...
then
  ...
  ${apt_cmd} install dpkg-dev git wget cmake \
       ...
       libsasl2-dev libxml2-dev libkrb5-dev libicu-dev unixodbc-dev libpq-dev
...
then
    ...
    sudo yum install -d1 -y --nogpgcheck ${enable_power_tools} \
         ...
         cyrus-sasl-devel libxml2-devel krb5-devel libicu-devel unixODBC-devel libpq-devel
