...
public:
    ...
    const string& get_default_server() const { return m_default_server; }
...
private:
    HintRouter(SERVICE* pService, HINT_TYPE default_action, string& default_server, int max_slaves);
...
private:
    ...
    static bool connect_to_backend(
