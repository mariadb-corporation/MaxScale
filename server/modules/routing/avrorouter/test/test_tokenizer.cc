...
} data[] =
{
    ...
    {
        "ALTER TABLE `t1` ADD `account_id` INT",
        {
            T::ALTER, T::TABLE, T::ID, T::ADD, T::ID, T::ID
        }
    },
    {
    ...
    {
        "ALTER TABLE `t1` ADD `amount` INT",
        {
            T::ALTER, T::TABLE, T::ID, T::ADD, T::ID, T::ID
        }
    },
    {
        "ALTER TABLE `t1` ADD `amount` INT NULL",
        {
            T::ALTER, T::TABLE, T::ID, T::ADD, T::ID, T::ID, T::SQLNULL
        }
    },
    {
    ...
    {
        "ALTER TABLE `t1` ADD `create_time` DATETIME",
        {
            T::ALTER, T::TABLE, T::ID, T::ADD, T::ID, T::ID
        }
    },
    {
        ...
        {
            T::ALTER, T::TABLE, T::ID, T::ADD, T::ID, T::ID, T::LP, T::ID, T::RP, T::DEFAULT, T::SQLNULL,
            T::COMMENT, T::ID
        }
    },
    {
    ...
    },
    {
        ...
        {
            T::ALTER, T::TABLE, T::ID, T::ADD, T::ID, T::ID, T::LP, T::ID, T::RP, T::DEFAULT, T::ID,
            T::COMMENT, T::ID
        }
    },
    {
    ...
    },
    {
        ...
        {
            T::ALTER, T::TABLE, T::ID, T::ADD, T::UNIQUE, T::ID, T::ID, T::ID,
            T::LP, T::ID, T::COMMA, T::ID, T::RP
        }
    },
    {
        "ALTER TABLE `t1` AUTO_INCREMENT = 1",
        {
            T::ALTER, T::TABLE, T::ID, T::AUTO_INCREMENT, T::EQ, T::ID
        }
    },
    {
    ...
    {
        "ALTER TABLE `t1` COMMENT = 'a comment'",
        {
            T::ALTER, T::TABLE, T::ID, T::COMMENT, T::EQ, T::ID
        }
    },
    {
        "alter table `t1` drop index a",
        {
            T::ALTER, T::TABLE, T::ID, T::DROP, T::INDEX, T::ID
        }
    },
    {
        "alter table t1 drop index t1_idx",
        {
            T::ALTER, T::TABLE, T::ID, T::DROP, T::INDEX, T::ID
        }
    },
    ...
    {
        "ALTER TABLE `t1` MODIFY COLUMN `expire_time` DATETIME DEFAULT NULL COMMENT 'this is a comment' AFTER `update_time`",
        {
            T::ALTER, T::TABLE, T::ID, T::MODIFY, T::COLUMN, T::ID, T::ID, T::DEFAULT, T::SQLNULL,
            T::COMMENT, T::ID, T::AFTER, T::ID
        }
    },
    {
        "ALTER TABLE `db1`.`t1` CHANGE COLUMN `num` `code` varchar(32) DEFAULT NULL COMMENT 'this is a comment'",
        {
            T::ALTER, T::TABLE, T::ID, T::DOT, T::ID, T::CHANGE, T::COLUMN, T::ID, T::ID, T::ID, T::LP, T::ID,
            T::RP, T::DEFAULT, T::SQLNULL, T::COMMENT, T::ID
        }
    },
    {
        "ALTER TABLE `db1`.`t1` DROP INDEX `a`, ADD INDEX `idx_a` USING BTREE (`a`) comment ''",
        {
            T::ALTER, T::TABLE, T::ID, T::DOT, T::ID, T::DROP, T::INDEX, T::ID, T::COMMA,
            T::ADD, T::INDEX, T::ID, T::ID, T::ID, T::LP, T::ID, T::RP, T::COMMENT, T::ID
        }
    },
    {
    ...
    },
    {
        ...
        {
            T::ALTER, T::TABLE, T::ID, T::RENAME, T::ID
        }
    },
    {
