...
static const MAXAVRO_SCHEMA_FIELD types[MAXAVRO_TYPE_MAX] = {{(char*) "int", NULL, MAXAVRO_TYPE_INT},
 ...
 */
static enum maxavro_value_type unpack_to_type(json_t* object, MAXAVRO_SCHEMA_FIELD* field)
{
