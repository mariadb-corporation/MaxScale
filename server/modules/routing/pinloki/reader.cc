...
void Reader::start()
{
    ...
    else
    {
        ...
        m_startup_poll_dcid = m_get_worker().delayed_call(1000ms, &Reader::poll_start_reading, this);
    }
}
...
void Reader::start_reading()
{
    ...
    {
        m_heartbeat_dcid = m_get_worker().delayed_call(1000ms, &Reader::generate_heartbeats, this);
    }
}
