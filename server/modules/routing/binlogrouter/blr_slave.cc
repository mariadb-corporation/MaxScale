...
static int blr_slave_replay(ROUTER_INSTANCE* router, ROUTER_SLAVE* slave, GWBUF* master)
{
    ...
    if (clone)
    {
        ...
        return mxs_route_reply(slave->up, clone, nullptr);
    }
    else
    {
...
static int blr_slave_send_timestamp(ROUTER_INSTANCE* router, ROUTER_SLAVE* slave)
{
    ...
    *ptr++ = ts_len;                        // Length of result string
    ...
    return mxs_route_reply(slave->up, pkt, nullptr);
}
                                 ...
                                 const char* new_file)
{
    ...
    int ret = r_event ? mxs_route_reply(slave->up, r_event, nullptr) : 0;
...
static uint32_t blr_slave_send_fde(ROUTER_INSTANCE* router, ROUTER_SLAVE* slave, GWBUF* fde)
{
    ...
    *ptr++ = 0;     // OK/ERR byte
    ...
    return mxs_route_reply(slave->up, event, nullptr);
}
...
static void send_heartbeat(ROUTER_INSTANCE* router, ROUTER_SLAVE* slave)
{
    ...
    worker->execute([slave, h_event]() {
                        mxs_route_reply(slave->up, h_event, nullptr);
                                        ...
                                        ROUTER_SLAVE* slave)
{
    ...
    return r_event ? mxs_route_reply(slave->up, r_event, nullptr) : 0;
}
                                   ...
                                   uint32_t serverid)
{
    ...
    return gl_event ? mxs_route_reply(slave->up, gl_event, nullptr) : 0;
}
                                 ...
                                 char** names)
{
        ...
        && values[3])   // Server ID
    {
                                         ...
                                         data_set->seq_no)) != NULL)
        {
            ...
            mxs_route_reply(data_set->slave->up, pkt, nullptr);
            /* Set success */
            ret = 0;
        }
