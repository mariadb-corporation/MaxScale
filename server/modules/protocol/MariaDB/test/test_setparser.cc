...
struct TEST_CASE
{
    ...
    {"SET SQL_MODE=DEFAULT", P::IS_SET_SQL_MODE, {{"SQL_MODE", "DEFAULT"}, {NULL, NULL}}},
    {"SET SQL_MODE=DEFAULT;", P::IS_SET_SQL_MODE, {{"SQL_MODE", "DEFAULT"}, {NULL, NULL}}},
    {"SET SQL_MODE=DEFAULT;   ", P::IS_SET_SQL_MODE, {{"SQL_MODE", "DEFAULT"}, {NULL, NULL}}},
    {"-- This is a comment\nSET SQL_MODE=DEFAULT",
        P::IS_SET_SQL_MODE,
        {{"SQL_MODE", "DEFAULT"}, {NULL, NULL}}},
    {"#This is a comment\nSET SQL_MODE=DEFAULT", P::IS_SET_SQL_MODE, {{"SQL_MODE", "DEFAULT"}, {NULL, NULL}}},
    {"/*blah*/ SET /*blah*/ SQL_MODE /*blah*/ = /*blah*/ DEFAULT /*blah*/ ",
        P::IS_SET_SQL_MODE,
        {{"SQL_MODE", "DEFAULT"}, {NULL, NULL}}},
    {"SET SQL_MODE=ORACLE", P::IS_SET_SQL_MODE, {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET SQL_MODE=BLAH",  // So short that it cannot be DEFAULT|ORACLE
        P::IS_SET_SQL_MODE,
        {{"SQL_MODE", "BLAH"}, {NULL, NULL}}},
    {"SET SQL_MODE='BLAH'", P::IS_SET_SQL_MODE, {{"SQL_MODE", "'BLAH'"}, {NULL, NULL}}},
    {"SET SQL_MODE=BLAHBLAH", P::IS_SET_SQL_MODE, {{"SQL_MODE", "BLAHBLAH"}, {NULL, NULL}}},
    {"SET SQL_MODE='ORACLE'", P::IS_SET_SQL_MODE, {{"SQL_MODE", "'ORACLE'"}, {NULL, NULL}}},
    {"SET SQL_MODE='BLAH, A, B, ORACLE'",
        P::IS_SET_SQL_MODE,
        {{"SQL_MODE", "'BLAH, A, B, ORACLE'"}, {NULL, NULL}}},
    {"SET SQL_MODE='BLAH, A, B, XYZ_123'",
        P::IS_SET_SQL_MODE,
        {{"SQL_MODE", "'BLAH, A, B, XYZ_123'"}, {NULL, NULL}}},
    {"SET VAR1=1234, VAR2=3456, SQL_MODE='A,B, ORACLE'",
        P::IS_SET_SQL_MODE,
        {{"SQL_MODE", "'A,B, ORACLE'"}, {NULL, NULL}}},
    {"SET SQL_MODE=ORACLE, VAR1=3456, VAR2='A=b, c=d', SQL_MODE='A,B, ORACLE'",
        P::IS_SET_SQL_MODE,
        {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET GLOBAL SQL_MODE=ORACLE", P::IS_SET_SQL_MODE, {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET SESSION SQL_MODE=ORACLE", P::IS_SET_SQL_MODE, {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET LOCAL SQL_MODE=ORACLE", P::IS_SET_SQL_MODE, {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET @@GLOBAL.SQL_MODE=ORACLE", P::IS_SET_SQL_MODE, {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET @@SESSION.SQL_MODE=ORACLE", P::IS_SET_SQL_MODE, {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET @@LOCAL.SQL_MODE=ORACLE", P::IS_SET_SQL_MODE, {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET @@LOCAL . SQL_MODE = ORACLE", P::IS_SET_SQL_MODE, {{"SQL_MODE", "ORACLE"}, {NULL, NULL}}},
    {"SET @@SESSION.blah = 1234, @@GLOBAL.blahblah = something, sql_mode=ORACLE",
        P::IS_SET_SQL_MODE,
        {{"sql_mode", "ORACLE"}, {NULL, NULL}}},
    {"SET MAXSCALE=", P::NOT_RELEVANT, {{NULL, NULL}}},
    {"SET MAXSCALE.CACHE.ENABLED=TRUE", P::NOT_RELEVANT, {{NULL, NULL}}},
    {"SET @MAXSCALE.CACHE.ENABLED=TRUE",
        P::IS_SET_MAXSCALE,
        {{"@MAXSCALE.CACHE.ENABLED", "TRUE"}, {NULL, NULL}}},
    {"SET @MAXSCALE.CACHE.ENABLED = TRUE /*blah*/",
        P::IS_SET_MAXSCALE,
        {{"@MAXSCALE.CACHE.ENABLED", "TRUE"}, {NULL, NULL}}},
    {"SET @MAXSCALE.CACHE.ENABLED = TRUE, @maxscale.cache.enabled = FALSE",
        P::IS_SET_MAXSCALE,
        {{"@MAXSCALE.CACHE.ENABLED", "TRUE"}, {"@maxscale.cache.enabled", "FALSE"}, {NULL, NULL}}},
};
...
int test(GWBUF** ppStmt, SetParser::status_t expected_status, const TEST_CASE::EXPECTATION expectations[])
{
    ...
    if (status == expected_status)
    {
        if ((status != SetParser::ERROR) && (status != SetParser::NOT_RELEVANT))
        {
            ...
            {
                cout << "ERROR: " << expectations[k].zVariable << " = " << expectations[k].zValue
                     << " not reported.";
                rv = EXIT_FAILURE;
            }
        }
