...
const char AUTHENTICATED_USERS[]             = "authenticatedUsers";
const char AUTHENTICATED_USER_PRIVILEGES[]   = "authenticatedUserPrivileges";
const char AUTHENTICATED_USER_ROLES[]        = "authenticatedUserRoles";
const char AUTH_INFO[]                       = "authInfo";
const char AVG_OBJ_SIZE[]                    = "avgObjSize";
...
const char COLLECTIONS[]                     = "collections";
...
const char FS_TOTAL_SIZE[]                   = "fsTotalSize";
const char FS_USED_SIZE[]                    = "fsUsedSize";
...
const char INDEX_SIZE[]                      = "indexSize";
...
const char SCALE_FACTOR[]                    = "scaleFactor";
...
const char STORAGE_SIZE[]                    = "storageSize";
