 ...
 */
PamBackendAuthenticator::PromptType PamBackendAuthenticator::parse_password_prompt(mariadb::ByteVec& data)
{
    ...
    if (msg_type == DIALOG_ECHO_ENABLED || msg_type == DIALOG_ECHO_DISABLED)
    {
        ...
        else
        {
            ...
            pw_type
                = (mxb::pam::match_prompt(prompt, EXP_PW_QUERY)) ? PromptType::PASSWORD : PromptType::TWO_FA;
        }
    }
    else
    {
...
mariadb::BackendAuthenticator::AuthRes PamBackendAuthenticator::exchange(
