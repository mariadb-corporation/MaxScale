...
describe("Monitor Relationships", function () {
  ...
  it("add relationships via `relationships` endpoint", function () {
    ...
    return request
      ...
      .then(() =>
        request.patch(base_url + "/monitors/" + monitor.data.id + "/relationships/servers", { json: created })
      )
      .then(() => request.get(base_url + "/monitors/MariaDB-Monitor"))
      .then((res) => {
  ...
  it("add service relationships to monitor via `relationships` endpoint", function () {
    return request
      .patch(base_url + "/monitors/MariaDB-Monitor/relationships/servers", { json: { data: null } })
      .then(() =>
        request.patch(base_url + "/monitors/MariaDB-Monitor/relationships/services", {
