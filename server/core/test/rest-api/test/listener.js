...
describe("Listener", function() {
    ...
    it("create a listener without a service", function() {
        return request.post(base_url + "/listeners", {json: listener})
            .should.be.rejected
    });
    ...
    it("destroy a listener", function() {
        return request.delete(base_url + "/listeners/RW-Split-Listener-2")
            .should.be.fulfilled
    });

    it("destroy a nonexistent listener", function() {
        return request.delete(base_url + "/listeners/I-bet-this-listener-exists")
            .should.be.rejected
    });
